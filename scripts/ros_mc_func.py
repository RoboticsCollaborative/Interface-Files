...
def main():
    ...
    rospy.Subscriber('daqFuncReset', Float32, callbackReset)
    rospy.Subscriber('daqFuncAmp', Float32, callbackAmp)
	...
	# Start the acquisition.
        ...
        try:
		    ...
		    if(resetVal == 0):
		        ...
		        pub.publish(data[index])
		        pub.publish(data[index + 1])
                        sleep(0.05)
